...
namespace BUS
{
    public class BUS_Hang
    {
        ...
        {
            return DAO_Hang.Instance.BangHang();
        }
        ...
        {
            BUS_Hang.Instance.totalPage = (int)Math.Ceiling(DAO_Hang.Instance.rowCount() / (double)this.pageSize);
        }

        public void pageCountByMaDM(int maDM)
        {
            BUS_Hang.Instance.totalPage = (int)Math.Ceiling(DAO_Hang.Instance.rowCountByMaDM(maDM) / (double)this.pageSize);
        }
