...
namespace DAO
{
    public class DAO_NhanVien
    {
        ...
        {
            String sql = "select *from nhanvien_test";
        ...
        public int RowCount()
        {
            String sql = "select count(*) from nhanvien_test";
        ...
        {
            String sql = String.Format("insert into nhanvien_test(username,password,hoten,sdt,diachi,namsinh,loainhanvien,gioitinh,ngaytao)" +
        ...
        {
            String sql = String.Format("delete from nhanvien_test where manv = {0}", manv);
            int effect = dataProvider.ExecuteNonQuery(sql);
            return effect;
        }
        ...
        {
            String sql = String.Format("update nhanvien_test set hoten='{0}',username='{1}',password='{2}',sdt='{3}'," +
