...
namespace BanLinhKien
{
    public partial class frm_NhapHang : Form
    {
        ...
        private void cbSapXep_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            switch (index)
            {
                case 0: dgvDanhSachHang.Sort(dgvDanhSachHang.Columns["mahang_nhaphang"], ListSortDirection.Ascending); break;
                case 1: dgvDanhSachHang.Sort(dgvDanhSachHang.Columns["giasanpham"], ListSortDirection.Descending);break;
                case 2: dgvDanhSachHang.Sort(dgvDanhSachHang.Columns["giasanpham"], ListSortDirection.Ascending);break;
            }
        }
        ...
        private void btnThemVaoGioNhapHang_Click(object sender, EventArgs e)
        {
            ...
            int gia = Convert.ToInt32(dgvDanhSachHang.CurrentRow.Cells["giasanpham"].Value);
