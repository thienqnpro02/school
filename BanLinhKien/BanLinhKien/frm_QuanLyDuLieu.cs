...
namespace BanLinhKien
{
    public partial class frm_QuanLyDuLieu : Form
    {
        ...
        private void Search_Danhmuc()
        {
            String timkiem = txtTimKiemDM.Text;
        ...
        private void BuocDLVaoCacDieuKhien_NhanVien()
        {
            ...
            rdNu.DataBindings.Add("Checked", dgvNhanVien.DataSource, "gioitinh");
        }
